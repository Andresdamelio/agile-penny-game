<template>
  <div class="custom-body">
    <configuration @play="onPlay" v-if="!isAlreadyConfigured && !gameFinished"></configuration>
    <board
      v-if="isAlreadyConfigured && !gameFinished"
      :configuration-result="configurationResult"
      v-on:endgame="onEndgame"
    ></board>
    <game-result v-if="gameFinished" :results="results"></game-result>
  </div>
</template>
